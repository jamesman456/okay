...
//           >
//             <Image src={message.src} alt={message.title} className="w-16 h-16 object-contain" />
//             <h3 className="mt-2 font-semibold text-center">{message.title}</h3>
//             <p className="text-gray-500 text-sm">{message.desc}</p>
//           </div>
//         ))}
//         </div>
...
//             </div>
//               <div className='py-10'>
//                 <Image src={selectedMessage.src }  className='w-16 m-auto h-16 object-contain' alt=''/>
//                 <h3 className="text-xl font-bold mb-4">{selectedMessage.title}</h3>
